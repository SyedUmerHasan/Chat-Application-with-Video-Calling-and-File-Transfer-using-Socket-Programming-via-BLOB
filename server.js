...
io.on("connection", function (socket) {
    ...
    socket.on('typing-stop', function (user) {
        ...
        // // Open CV Initialization on the User end with variables 
        // const FPS = 100;
        // const vCap = new cv.VideoCapture(0);
        // vCap.set(cv.CAP_PROP_FRAME_WIDTH, 800);
        // vCap.set(cv.CAP_PROP_FRAME_HEIGHT, 800);
        // var count = 0;
        // // Camera running Interval Start
        // setInterval(() => {
        //     // console.log(count++)
        //     start();
        // }, 70);
        // // Camera running Interval End
    ...
    ss(socket).on('file', (stream, data) => {
        ...
        var filename = "public/music-stream/" + varaible_time + '.' + data.fileextension;
